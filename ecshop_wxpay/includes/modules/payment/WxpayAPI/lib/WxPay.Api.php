...
require_once dirname(str_replace('\\', '/' , __FILE__)) . "/WxPay.Exception.php";
require_once dirname(str_replace('\\', '/' , __FILE__)) . "/WxPay.Config.php";
require_once dirname(str_replace('\\', '/' , __FILE__)) . "/WxPay.Data.php";
